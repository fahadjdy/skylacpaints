                    ...
                    <!--/app header-->
					  ...
					  <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">View Product</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>"><i class="fe fe-shopping-cart mr-2 fs-14"></i>Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="#">View Product</a></li>
                            </ol>
                        </div>
	...
	<script>
		 ...
		 $(document).ready(function () {
		  ...
		  $('#example1').on('click','.delete',function(){
			  ...
			  $.ajax({
				  url: "<?php echo base_url("Admin/deleteCategory/");?>"+p_id,
				  type: "GET",
