                    ...
                    <div class="page-header">
                        ...
                        <div class="page-rightheader">
                            <div class="btn btn-list">
                                <a href="<?php echo base_url('Admin/addcategory') ?>" class="btn btn-info"><i class="fe fe-plus"></i> Add </a>
                            </div>
                        </div>
                    </div>
                    <!--End Page header-->
                                        ...
                                        <table class="table table-bordered" id="example1">
                                            ...
                                            <tbody>
												...
												<tr>
                                                    ...
                                                    <td  style="width: 10% !important;"><?php echo $category->c_name; ?></td>
                                                    <td  style="width: 100% !important;overflow: hidden !important; overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 3;line-clamp: 3; -webkit-box-orient: vertical;" >
															<?php echo $category->c_content; ?>
													</td>
                                                    <td  style="width: 5% !important;" > <a href="<?php echo base_url('Admin/viewcategory/'.$category->c_id); ?>"> <i class="fa fa-eye btn btn-dark"></i> </a></td>
                                                    <td  style="width: 10% !important;" > <a href="<?php echo base_url('Admin/editcategory/'.$category->c_id); ?>"> <i class="fa fa-edit btn btn-primary"></i> </a><i class="fa fa-trash btn btn-danger delete" id="<?php echo $category->c_id; ?>"></i></td>
                                                </tr>
